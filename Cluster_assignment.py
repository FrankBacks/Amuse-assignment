...
def simulate_small_cluster(
    ...
    particles = new_fractal_cluster_model(masses = masses, do_scale=True)
...
if __name__ == "__main__":
    times, positions_at_different_time, masses = simulate_small_cluster(10, 9.0 | nbody_system.time, number_of_workers=5)
    ...
    #ani.save("Test03.mp4", writer="ffmpeg", bitrate=-1)
